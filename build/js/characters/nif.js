var nif = (function() {
  ...
  var data = {
    ...
    textarea: {
      ...
      special_abilities: "Arcane bond (Su), Bonus feats, Cantrips, Arcane schools, Teleportation sub school, Opposition arcane school, Elven Immunities (Ex), Elven Magic (Ex), Keen Senses (Ex), Low_Light Vision (Ex), Headband of Intellect Skill, Linguistics Skill, Shift (Su), Summoner's Charm (Su), Weapon Familiarity (Ex)",
