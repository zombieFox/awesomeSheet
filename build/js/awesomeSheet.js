...
var orrin = (function() {
  ...
  var data = {
    ...
    statistics: {
      ...
      feats: "Weapon Finesse, Dodge, Two-Weapon Fighting, Weapon focus, Deft hands",
...
var vos = (function() {
  ...
  var data = {
    ...
    offense: {
      ...
      attack_notes: "+1 weapon focus (Unarmed strike). +2 grapple, +2 to resist grapple. +2 disarm, +2 CMD to resist disarm."
    },
    skills: {
      spent_ranks: {
        include_custom: false,
